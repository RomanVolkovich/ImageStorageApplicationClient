...
export class AlertComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.alertSubscription = this.alertService.onAlert(this.id)
            .subscribe(alert => {
                ...
                // автоматическое скрытие оповещения
                if (alert.autoClose) {
                    setTimeout(() => this.removeAlert(alert),
                        alert.type !== 1 ? 3000 : 1500);
                }
           });
    ...
    // при нажатии на оповещение - скрываем его
